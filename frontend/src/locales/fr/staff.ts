export const staff = {
  ...
  dialog: {
    ...
    addDescription: "Créer un nouveau scanneur ou réceptionniste pour votre centre.",
    editTitle: "Modifier le membre",
    editDescription: "Mettre à jour les informations de ce membre du personnel.",
  ...
  errors: {
    centerMismatch: "Vous ne pouvez gérer que le personnel de votre propre centre.",
    notFound: "Membre du personnel introuvable.",
    loadFailed: "Impossible de charger le personnel. Veuillez réessayer.",
    createFailed: "Impossible de créer le membre du personnel. Veuillez réessayer.",
    updateFailed: "Impossible de mettre à jour le membre du personnel. Veuillez réessayer.",
    deleteFailed: "Impossible de supprimer le membre du personnel. Veuillez réessayer.",
